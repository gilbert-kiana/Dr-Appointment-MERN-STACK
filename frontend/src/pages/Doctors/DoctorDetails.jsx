                    ...
                    <div className="md:col-span-2">
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <p className="text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere recusandae veritatis natus velit ipsum labore, sapiente iure fugit tempore nobis.</p>
                            </div>
                        </div>
